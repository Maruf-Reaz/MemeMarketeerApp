...
namespace MemeMarketeerApp.Migrations
{
    ...
    [Migration("20210713170249_CatagoryAndLanguageUpdated")]
    partial class CatagoryAndLanguageUpdated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemeMarketeerApp.Models.Affiliate", b =>
                {
                    ...
                    b.Property<int?>("AffiliateLanguageId");
                    ...
                    b.Property<double>("PaymentForPost");

                    b.Property<double>("PaymentForPostPlusStory");

                    b.Property<double>("PaymentForStory");

                    b.Property<int>("Status");

                    b.Property<string>("TotalFollwers");

                    b.Property<string>("WANumber");

                    b.HasKey("Id");

                    b.HasIndex("AffiliateLanguageId");
            ...
            modelBuilder.Entity("MemeMarketeerApp.Models.AffiliateLanguage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MemeMarketeerApp.Models.Catagory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MemeMarketeerApp.Models.Expense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MemeMarketeerApp.Models.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("CommentsGenerated");

                    b.Property<double>("ImpressionGenerated");

                    b.Property<string>("Name");

                    b.Property<double>("PaidAmount");

                    b.Property<double>("PostReached");

                    b.Property<int>("PostTypeId");

                    b.Property<string>("ReactionGenerated");

                    b.Property<double>("StoryViewed");
            ...
            modelBuilder.Entity("MemeMarketeerApp.Models.PostType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MemeMarketeerApp.Models.Affiliate", b =>
                {
                    b.HasOne("MemeMarketeerApp.Models.AffiliateLanguage", "AffiliateLanguage")
                        .WithMany()
                        .HasForeignKey("AffiliateLanguageId");

                    b.HasOne("MemeMarketeerApp.Models.Catagory", "Catagory")
                        .WithMany()
            ...
            modelBuilder.Entity("MemeMarketeerApp.Models.Expense", b =>
                {
                    b.HasOne("MemeMarketeerApp.Models.Campaign", "Campaign")
                        .WithMany()
            ...
            modelBuilder.Entity("MemeMarketeerApp.Models.Post", b =>
                {
                    b.HasOne("MemeMarketeerApp.Models.Affiliate", "Affiliate")
                        .WithMany()
                    ...
                    b.HasOne("MemeMarketeerApp.Models.PostType", "PostType")
                        .WithMany()
